...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'football_leaguemembership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('universe', self.gf('django.db.models.fields.related.ForeignKey')(related_name='membership_universe', to=orm['football.Universe'])),
            ('year', self.gf('django.db.models.fields.related.ForeignKey')(related_name='membership_year', to=orm['football.Year'])),
            ('league', self.gf('django.db.models.fields.related.ForeignKey')(related_name='membership_league', to=orm['football.League'])),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(related_name='membership_team', to=orm['football.Team'])),
        ))
        db.send_create_signal(u'football', ['LeagueMembership'])

        # Adding model 'League'
        db.create_table(u'football_league', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('universe', self.gf('django.db.models.fields.related.ForeignKey')(related_name='league_universe', to=orm['football.Universe'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'football', ['League'])


    def backwards(self, orm):
        # Deleting model 'LeagueMembership'
        db.delete_table(u'football_leaguemembership')

        # Deleting model 'League'
        db.delete_table(u'football_league')
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["P", "RB", "DE", "QB", "CB", "OT", "C", "K", "LB", "DT", "OG", "S", "WR"]\'', 'max_length': '200'}),
