...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'football_coach', 'fg_dist_probabilities', self.gf('django.db.models.fields.CharField')(max_length=10000))

        # Changing field 'Coach.play_probabilities'
        db.alter_column(u'football_coach', 'play_probabilities', self.gf('django.db.models.fields.CharField')(max_length=10000))

    def backwards(self, orm):

        # Changing field 'Coach.fg_dist_probabilities'
        db.alter_column(u'football_coach', 'fg_dist_probabilities', self.gf('django.db.models.fields.CharField')(max_length=5000))

        # Changing field 'Coach.play_probabilities'
        db.alter_column(u'football_coach', 'play_probabilities', self.gf('django.db.models.fields.CharField')(max_length=5000))
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["S", "CB", "WR", "LB", "OT", "DE", "DT", "OG", "RB", "K", "P", "QB", "C"]\'', 'max_length': '200'}),
