...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.universe'
        db.add_column(u'football_game', 'universe',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='game_universe', to=orm['football.Universe']),
                      keep_default=False)

        # Adding field 'Game.year'
        db.add_column(u'football_game', 'year',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='game_year', to=orm['football.Year']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.universe'
        db.delete_column(u'football_game', 'universe_id')

        # Deleting field 'Game.year'
        db.delete_column(u'football_game', 'year_id')
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["RB", "WR", "C", "QB", "S", "DE", "LB", "OT", "K", "DT", "OG", "CB", "P"]\'', 'max_length': '200'}),
