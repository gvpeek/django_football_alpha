...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'football_champions', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('universe', self.gf('django.db.models.fields.related.ForeignKey')(related_name='champions_universe', to=orm['football.Universe'])),
            ('year', self.gf('django.db.models.fields.related.ForeignKey')(related_name='champions_year', to=orm['football.Year'])),
            ('league', self.gf('django.db.models.fields.related.ForeignKey')(related_name='champions_league', to=orm['football.League'])),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(related_name='champions_team', to=orm['football.Team'])),
        ))
        db.send_create_signal(u'football', ['Champions'])

        # Adding model 'PlayoffTeams'
        db.create_table(u'football_playoffteams', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('universe', self.gf('django.db.models.fields.related.ForeignKey')(related_name='playoff_universe', to=orm['football.Universe'])),
            ('year', self.gf('django.db.models.fields.related.ForeignKey')(related_name='playoff_year', to=orm['football.Year'])),
            ('league', self.gf('django.db.models.fields.related.ForeignKey')(related_name='playoff_league', to=orm['football.League'])),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(related_name='playoff_team', to=orm['football.Team'])),
            ('seed', self.gf('django.db.models.fields.IntegerField')()),
            ('qualification', self.gf('django.db.models.fields.CharField')(max_length=9)),
        ))
        db.send_create_signal(u'football', ['PlayoffTeams'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'football_champions')

        # Deleting model 'PlayoffTeams'
        db.delete_table(u'football_playoffteams')
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["LB", "OT", "QB", "WR", "CB", "OG", "DE", "S", "P", "K", "C", "DT", "RB"]\'', 'max_length': '200'}),
