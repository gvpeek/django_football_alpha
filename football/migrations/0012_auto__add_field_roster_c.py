...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Roster.c'
        db.add_column(u'football_roster', 'c',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='center', null=True, to=orm['football.Player']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Roster.c'
        db.delete_column(u'football_roster', 'c_id')
