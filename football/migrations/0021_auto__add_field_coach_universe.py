...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coach.universe'
        db.add_column(u'football_coach', 'universe',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='coach_universe', to=orm['football.Universe']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coach.universe'
        db.delete_column(u'football_coach', 'universe_id')
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["QB", "S", "DE", "LB", "OG", "C", "K", "RB", "CB", "WR", "OT", "DT", "P"]\'', 'max_length': '200'}),
