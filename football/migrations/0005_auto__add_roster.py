...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Roster'
        db.create_table(u'football_roster', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['football.Team'])),
            ('year', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['football.Year'])),
            ('qb', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['football.Player'])),
        ))
        db.send_create_signal(u'football', ['Roster'])


    def backwards(self, orm):
        # Deleting model 'Roster'
        db.delete_table(u'football_roster')
    ...
    models = {
        ...
        u'football.roster': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'qb': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['football.Player']"}),
