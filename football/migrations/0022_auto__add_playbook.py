...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'football_playbook', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal(u'football', ['Playbook'])


    def backwards(self, orm):
        # Deleting model 'Playbook'
        db.delete_table(u'football_playbook')
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["CB", "WR", "OT", "LB", "P", "OG", "K", "DE", "QB", "C", "RB", "S", "DT"]\'', 'max_length': '200'}),
