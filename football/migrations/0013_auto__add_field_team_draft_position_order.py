...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.draft_position_order'
        db.add_column(u'football_team', 'draft_position_order',
                      self.gf('django.db.models.fields.CharField')(default='["P", "QB", "DE", "C", "LB", "DT", "RB", "WR", "S", "OT", "OG", "K", "CB"]', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.draft_position_order'
        db.delete_column(u'football_team', 'draft_position_order')
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["P", "QB", "DE", "C", "LB", "DT", "RB", "WR", "S", "OT", "OG", "K", "CB"]\'', 'max_length': '200'}),
