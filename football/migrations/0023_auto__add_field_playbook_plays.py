...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Playbook.plays'
        db.add_column(u'football_playbook', 'plays',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=10000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Playbook.plays'
        db.delete_column(u'football_playbook', 'plays')
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["DE", "K", "RB", "LB", "WR", "CB", "OG", "P", "C", "QB", "S", "DT", "OT"]\'', 'max_length': '200'}),
