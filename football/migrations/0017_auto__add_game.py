...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Game'
        db.create_table(u'football_game', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('home_team', self.gf('django.db.models.fields.related.ForeignKey')(related_name='game_home_team', to=orm['football.Team'])),
            ('away_team', self.gf('django.db.models.fields.related.ForeignKey')(related_name='game_away_team', to=orm['football.Team'])),
            ...
            ('league_game', self.gf('django.db.models.fields.BooleanField')()),
            ('division_game', self.gf('django.db.models.fields.BooleanField')()),
            ('conference_game', self.gf('django.db.models.fields.BooleanField')()),
            ('playoff_game', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'football', ['Game'])


    def backwards(self, orm):
        # Deleting model 'Game'
        db.delete_table(u'football_game')
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["P", "RB", "WR", "OG", "DE", "S", "OT", "LB", "CB", "K", "C", "QB", "DT"]\'', 'max_length': '200'}),
