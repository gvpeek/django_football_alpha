...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'League.number_playoff_teams'
        db.add_column(u'football_league', 'number_playoff_teams',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'League.number_playoff_teams'
        db.delete_column(u'football_league', 'number_playoff_teams')
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["LB", "S", "K", "CB", "P", "DE", "OG", "WR", "C", "RB", "OT", "QB", "DT"]\'', 'max_length': '200'}),
