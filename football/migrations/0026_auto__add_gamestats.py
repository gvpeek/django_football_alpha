...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'football_gamestats', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('universe', self.gf('django.db.models.fields.related.ForeignKey')(related_name='gamestats_universe', to=orm['football.Universe'])),
            ('year', self.gf('django.db.models.fields.related.ForeignKey')(related_name='gamestats_year', to=orm['football.Year'])),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(related_name='gamestats_game', to=orm['football.Game'])),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(related_name='gamestats_team', to=orm['football.Team'])),
        ...
        db.send_create_signal(u'football', ['GameStats'])


    def backwards(self, orm):
        # Deleting model 'GameStats'
        db.delete_table(u'football_gamestats')
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["C", "WR", "OT", "OG", "RB", "LB", "S", "DT", "DE", "QB", "P", "CB", "K"]\'', 'max_length': '200'}),
