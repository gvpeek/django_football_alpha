...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Schedule.played'
        db.add_column(u'football_schedule', 'played',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Schedule.played'
        db.delete_column(u'football_schedule', 'played')
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["OT", "K", "OG", "C", "QB", "S", "WR", "LB", "CB", "DE", "P", "RB", "DT"]\'', 'max_length': '200'}),
