...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'football_playoffteamstats', (
            (u'teamstats_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['football.TeamStats'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'football', ['PlayoffTeamStats'])


    def backwards(self, orm):
        # Deleting model 'PlayoffTeamStats'
        db.delete_table(u'football_playoffteamstats')
    ...
    models = {
        ...
        u'football.playoffteamstats': {
            'Meta': {'object_name': 'PlayoffTeamStats', '_ormbases': [u'football.TeamStats']},
            u'teamstats_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['football.TeamStats']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'football.roster': {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["OT", "S", "P", "CB", "OG", "QB", "RB", "C", "WR", "DE", "DT", "K", "LB"]\'', 'max_length': '200'}),
