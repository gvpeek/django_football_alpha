...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'football_schedule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('universe', self.gf('django.db.models.fields.related.ForeignKey')(related_name='schedule_universe', to=orm['football.Universe'])),
            ('year', self.gf('django.db.models.fields.related.ForeignKey')(related_name='schedule_year', to=orm['football.Year'])),
            ('league', self.gf('django.db.models.fields.related.ForeignKey')(related_name='schedule_league', to=orm['football.League'])),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(related_name='schedule_game', to=orm['football.Game'])),
            ('week', self.gf('django.db.models.fields.IntegerField')()),
            ('game_number', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'football', ['Schedule'])


    def backwards(self, orm):
        # Deleting model 'Schedule'
        db.delete_table(u'football_schedule')
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["QB", "DE", "C", "DT", "RB", "OT", "K", "LB", "P", "OG", "S", "WR", "CB"]\'', 'max_length': '200'}),
