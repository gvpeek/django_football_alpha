...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlayoffTeams.eliminated'
        db.add_column(u'football_playoffteams', 'eliminated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlayoffTeams.eliminated'
        db.delete_column(u'football_playoffteams', 'eliminated')
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["C", "QB", "CB", "RB", "DE", "LB", "OG", "OT", "K", "DT", "S", "P", "WR"]\'', 'max_length': '200'}),
