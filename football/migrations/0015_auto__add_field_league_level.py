...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'League.level'
        db.add_column(u'football_league', 'level',
                      self.gf('django.db.models.fields.CharField')(default='pro', max_length=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'League.level'
        db.delete_column(u'football_league', 'level')
    ...
    models = {
        ...
        u'football.team': {
            ...
            'draft_position_order': ('django.db.models.fields.CharField', [], {'default': '\'["DE", "S", "P", "LB", "RB", "QB", "C", "CB", "OT", "OG", "WR", "DT", "K"]\'', 'max_length': '200'}),
